...
func (e *ElasticRepository) WriteUserAction(ctx context.Context, ua *entity.UserAction) error {
	if ua.ActionType == entity.UserActionShareAssessment || ua.ActionType == entity.UserActionUnshareAssessment {
...
func (e *ElasticRepository) writeAssessmentCreated(ctx context.Context, result entity.AssessmentResult) error {
	...
	// AssessmentID is used as the Elasticsearch document _id
	if err := e.write(ctx, result.Assessment.Index, result.Assessment.AssessmentID, data); err != nil {
