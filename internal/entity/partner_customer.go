...
func NewPartnerCustomer(id, customerUsername, partnerID, requestStatus, location string, acceptedAt, terminatedAt *time.Time, createdAt time.Time, eventSource string) *PartnerCustomer {
	pc := &PartnerCustomer{
