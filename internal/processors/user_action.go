...
func ShareAssessmentProcessor(_ context.Context, event entity.Event[plannerEvents.UserActionEventPayload]) (entity.ShareAssessmentResult, error) {
	action := event.Payload.UserAction
...
func UnshareAssessmentProcessor(_ context.Context, event entity.Event[plannerEvents.UserActionEventPayload]) (entity.UnshareAssessmentResult, error) {
	action := event.Payload.UserAction
	dataBytes, err := json.Marshal(action.Data)
	if err != nil {
...
func SizingRequestedProcessor(_ context.Context, event entity.Event[plannerEvents.UserActionEventPayload]) (entity.SizingRequestedResult, error) {
	action := event.Payload.UserAction
	dataBytes, err := json.Marshal(action.Data)
	if err != nil {
...
func ComplexityEstimatedProcessor(_ context.Context, event entity.Event[plannerEvents.UserActionEventPayload]) (entity.ComplexityEstimatedResult, error) {
	action := event.Payload.UserAction
	dataBytes, err := json.Marshal(action.Data)
	if err != nil {
...
func TimeEstimatedProcessor(_ context.Context, event entity.Event[plannerEvents.UserActionEventPayload]) (entity.TimeEstimatedResult, error) {
	action := event.Payload.UserAction
	dataBytes, err := json.Marshal(action.Data)
	if err != nil {
...
func OVADownloadedProcessor(_ context.Context, event entity.Event[plannerEvents.UserActionEventPayload]) (entity.OVADownloadedResult, error) {
	action := event.Payload.UserAction
	dataBytes, err := json.Marshal(action.Data)
	if err != nil {
...
func VisitedProcessor(_ context.Context, event entity.Event[plannerEvents.UserActionEventPayload]) (entity.VisitedResult, error) {
	action := event.Payload.UserAction
	dataBytes, err := json.Marshal(action.Data)
	if err != nil {
